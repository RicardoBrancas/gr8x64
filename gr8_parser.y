...
type   : tSMALL       { $$ = new basic_type(4, basic_type::TYPE_INT);                        }
       | smalls tFAKE { $$ = new basic_type(8, basic_type::TYPE_POINTER); $$->_subtype = $1; }
       | tHUGE        { $$ = new basic_type(8, basic_type::TYPE_DOUBLE);                     }
       | huges tFAKE  { $$ = new basic_type(8, basic_type::TYPE_POINTER); $$->_subtype = $1; }
       | tNEWS        { $$ = new basic_type(8, basic_type::TYPE_STRING);                     }
       | fakes tNEWS  { $$ = new basic_type(8, basic_type::TYPE_POINTER); $$->_subtype = $1; }
       ;

smalls : tSMALL         { $$ = new basic_type(4, basic_type::TYPE_INT);                        }
       | smalls tSMALL  { $$ = new basic_type(8, basic_type::TYPE_POINTER); $$->_subtype = $1; }
       ;

huges  : tHUGE        { $$ = new basic_type(8, basic_type::TYPE_DOUBLE);                     }
       | huges tHUGE  { $$ = new basic_type(8, basic_type::TYPE_POINTER); $$->_subtype = $1; }
       ;

fakes  : tFAKE        { $$ = new basic_type(8, basic_type::TYPE_STRING);                     }
       | fakes tFAKE  { $$ = new basic_type(8, basic_type::TYPE_POINTER); $$->_subtype = $1; }
       ;
